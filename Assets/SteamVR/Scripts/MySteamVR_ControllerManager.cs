...
public class MySteamVR_ControllerManager : MonoBehaviour
{
    ...
    private void SetTrackedDeviceIndex(int objectIndex, uint trackedDeviceIndex)
    {
        ...
        {
            Debug.Log("trackedDeviceIndex----->" + trackedDeviceIndex + "\n" + " indices[objectIndex]---->" + objectIndex + " " + indices[objectIndex]);
            indices[objectIndex] = trackedDeviceIndex;

            var obj = objects[objectIndex];
            if (obj != null)
            {
                Debug.Log("gameobject------>" + obj.name + "    index----->" + trackedDeviceIndex);
                if (trackedDeviceIndex == OpenVR.k_unTrackedDeviceIndexInvalid)
                {
                    obj.SetActive(false);
                }
    ...
    {
        Debug.Log("OnTrackedDeviceRoleChanged------>Refresh()");
        Refresh();
    }
    ...
    private void OnDeviceConnected(int index, bool connected)
    {
        ...
        if (changed)
        {
            Debug.Log("OnDeviceConnected-------->Refresh()");
            Refresh();
        }
    }
    ...
    public void Refresh()
    {
        ...
        if (leftIndex == OpenVR.k_unTrackedDeviceIndexInvalid && rightIndex == OpenVR.k_unTrackedDeviceIndexInvalid)
        {
            ...
            Debug.Log("neither role has been assigned yet");
